...
class SFTDataset(Dataset):
    ...
    def _read_files_and_tokenize(self):
        ...
        # debug 需要是extra_info
        print("prompt key is: ", self.prompt_key)
        ...
        print("extra_info对应的raw prompt 0 is: ", self.prompts[0])
        print("extra_info对应的raw prompt 1 is: ", self.prompts[1])
        print("extra_info对应的raw prompt 2 is: ", self.prompts[2])
    ...
    def __getitem__(self, item):
        ...
        if item < 2:  # 只打印前2个样本
            ...
            print(f"Sample {item}:")
            print(f"{'='*80}")
            print(f"Original prompt: {prompt[:200]}...")  # 截断显示
            print(f"\nAfter template:")
